...
library DydxPoolController {
    ...
    address constant private _dydxContract = 0x1E0447b19BB6EcFdAe1e4AE1694b0C3659614e4e;
    ...
    function getMarketId(address erc20Contract) private pure returns (uint256) {
        if (erc20Contract == 0x6B175474E89094C44Da98b954EedeAC495271d0F) return 3;
    ...
    function getBalance(address erc20Contract) internal view returns (uint256) {
        ...
        SoloMargin soloMargin = SoloMargin(_dydxContract);
        ...
        (tokens, pars, weis) = soloMargin.getAccountBalances(account);
    ...
    function deposit(address erc20Contract, uint256 amount) internal returns (bool) {
        ...
        SoloMargin(_dydxContract).operate(accounts, actions);
